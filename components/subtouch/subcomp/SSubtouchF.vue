    ...
    <main v-if="selectedContent" class="rchv" id="mSS1" v-pan="onPan">
      <article class="article">
        ...
        <Homepage12TargetFinancial
          ...
          class="A-bs n0"
        />
        <Homepage12TargetDesignNowrap
          v-if="isHomepage3DialogActive"
          class="A-bs n0"
        />
        <Homepage12TargetFinancialBNowrap
...
import Homepage12TargetFinancial from '~/components/homepage/subcomp/Homepage12TargetFinancial.vue'
import Homepage12TargetDesignNowrap from '~/components/homepage/subcomp/Homepage12TargetDesignNowrap.vue'
import Homepage12TargetFinancialBNowrap from '~/components/homepage/subcomp/Homepage12TargetFinancialBNowrap.vue'
  ...
  data() {
    return {
      ...
      cosas: [
        ...
        "Navigate to know more about License",
        "Navigate to know more about Exceed",
    ...
    isHomepage5DialogActive() {
      ...
      } else if (this.selected === "License") {
        return this.cosas[this.indices.indexOf('License')];
      } else if (this.selected === "Exceed") {
        return this.cosas[this.indices.indexOf('Exceed')];
