...
<template>
  <!--eslint-disable-->
  <div class="cntnr">
    <div class="day c-d1 a5">
      <div class="declaration declaration1">
        <div class="text">
          <div id="target-d1 tI" class="t-s-d3 t-d3var">Exploit an haute-couture design strategy.
            <div class="sbt-d3 tI">If you sell your property furnished,</div>
            <div class="c-s2-d3">
              <div class="s2-d3 tI">Give your customer a full, Italian</div>
              <div class="s-s22-d3">
            ...
            <div class="c-s4-s5-d3">
              <div class="s4-d3 tI s4-d3-bsnss">Tailor bespoke design brought to your developments</div>
              <div class="s44-d3 tI">brings physical quality to match your service quality.</div>
              <div class="s5-d3 tI">*Is this the best haute-couture tweak for you? We will find out.</div>
            </div>
            <Help v-if="father === 'Homepage5Scrollto'" :mother="mother" />
          </div>
        </div>
      </div>
    </div>
