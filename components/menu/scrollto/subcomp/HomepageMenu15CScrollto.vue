...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage15CScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage15CScrolltoShared from '~/components/shared/Homepage15CScrolltoShared.vue'

export default {
  components: {
    Homepage15CScrolltoShared
  }
}
</script>
