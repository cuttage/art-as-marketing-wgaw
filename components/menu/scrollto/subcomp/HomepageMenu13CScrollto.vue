...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage13CScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage13CScrolltoShared from '~/components/shared/Homepage13CScrolltoShared.vue'

export default {
  components: {
    Homepage13CScrolltoShared
  }
}
</script>
