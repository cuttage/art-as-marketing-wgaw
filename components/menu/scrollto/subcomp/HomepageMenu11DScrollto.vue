...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage11DScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage11DScrolltoShared from '~/components/shared/Homepage11DScrolltoShared.vue'

export default {
  components: {
    Homepage11DScrolltoShared
  }
}
</script>
