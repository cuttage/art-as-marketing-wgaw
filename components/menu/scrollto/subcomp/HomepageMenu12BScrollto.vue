...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage12BScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage12BScrolltoShared from '~/components/shared/Homepage12BScrolltoShared.vue'

export default {
  components: {
    Homepage12BScrolltoShared
  }
}
</script>
