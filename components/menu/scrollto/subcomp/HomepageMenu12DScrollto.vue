...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage12DScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage12DScrolltoShared from '~/components/shared/Homepage12DScrolltoShared.vue'

export default {
  components: {
    Homepage12DScrolltoShared
  }
}
</script>
