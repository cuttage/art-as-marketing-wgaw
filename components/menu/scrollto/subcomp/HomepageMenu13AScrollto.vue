...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage13AScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage13AScrolltoShared from '~/components/shared/Homepage13AScrolltoShared.vue'

export default {
  components: {
    Homepage13AScrolltoShared
  }
}
</script>
