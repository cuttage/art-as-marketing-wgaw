...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage12CScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage12CScrolltoShared from '~/components/shared/Homepage12CScrolltoShared.vue'

export default {
  components: {
    Homepage12CScrolltoShared
  }
}
</script>
