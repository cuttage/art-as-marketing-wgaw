...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage14EScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage14EScrolltoShared from '~/components/shared/Homepage14EScrolltoShared.vue'

export default {
  components: {
    Homepage14EScrolltoShared
  }
}
</script>
