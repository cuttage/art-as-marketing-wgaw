...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage11AScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage11AScrolltoShared from '~/components/shared/Homepage11AScrolltoShared.vue'

export default {
  components: {
    Homepage11AScrolltoShared
  }
}
</script>
