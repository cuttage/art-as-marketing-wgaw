...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage11EScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage11EScrolltoShared from '~/components/shared/Homepage11EScrolltoShared.vue'

export default {
  components: {
    Homepage11EScrolltoShared
  }
}
</script>
