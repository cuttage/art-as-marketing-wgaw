...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage15DScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage15DScrolltoShared from '~/components/shared/Homepage15DScrolltoShared.vue'

export default {
  components: {
    Homepage15DScrolltoShared
  }
}
</script>
