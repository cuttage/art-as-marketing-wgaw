...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage15BScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage15BScrolltoShared from '~/components/shared/Homepage15BScrolltoShared.vue'

export default {
  components: {
    Homepage15BScrolltoShared
  }
}
</script>
