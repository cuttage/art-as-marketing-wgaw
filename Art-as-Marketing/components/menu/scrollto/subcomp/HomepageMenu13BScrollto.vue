...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage13BScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage13BScrolltoShared from '~/components/shared/Homepage13BScrolltoShared.vue'

export default {
  components: {
    Homepage13BScrolltoShared
  }
}
</script>
