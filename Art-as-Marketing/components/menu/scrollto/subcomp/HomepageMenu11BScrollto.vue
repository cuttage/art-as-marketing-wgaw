...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage11BScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage11BScrolltoShared from '~/components/shared/Homepage11BScrolltoShared.vue'

export default {
  components: {
    Homepage11BScrolltoShared
  }
}
</script>
