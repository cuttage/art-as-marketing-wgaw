...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage13EScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage13EScrolltoShared from '~/components/shared/Homepage13EScrolltoShared.vue'

export default {
  components: {
    Homepage13EScrolltoShared
  }
}
</script>
