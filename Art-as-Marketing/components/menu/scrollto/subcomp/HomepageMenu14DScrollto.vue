...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage14DScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage14DScrolltoShared from '~/components/shared/Homepage14DScrolltoShared.vue'

export default {
  components: {
    Homepage14DScrolltoShared
  }
}
</script>
