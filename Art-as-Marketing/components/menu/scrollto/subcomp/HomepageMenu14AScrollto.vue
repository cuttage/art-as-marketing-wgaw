...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage14AScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage14AScrolltoShared from '~/components/shared/Homepage14AScrolltoShared.vue'

export default {
  components: {
    Homepage14AScrolltoShared
  }
}
</script>
