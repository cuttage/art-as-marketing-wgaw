...
<template>
  <div class="lngr">
    <div class="disable">
      <Homepage12EScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage12EScrolltoShared from '~/components/shared/Homepage12EScrolltoShared.vue'

export default {
  components: {
    Homepage12EScrolltoShared
  }
}
</script>
